...
**Data de revisió:** 9 d'agost de 2026
...
| Parcial | Redactat, però depèn d'un fet extern o d'un acte municipal pendent |
...
| A4 | **10.3.a** Nivell de maduresa tecnològica | Cobert | `proposta-pulsepath-contingut.md` → §2 Nivell de maduresa tecnològica (**TRL 5**; inventari real + compromís de preflight previ a l'activació municipal) |
...
| B3 | Nivell de maduresa tecnològica TRL 5 o superior | Cobert | `§2 Nivell de maduresa tecnològica` declara **TRL 5** (sistema construït i integrat; validació operativa amb plantilla real = objectiu de la prova) |
...
| C2 | **Art. 13.4** Assumpció de costos municipals + proporcionalitat | Cobert | `§4 Actius necessaris` — clàusula de tope econòmic de **1.000 €** |
...
1. Emplenar a mà les dades personals del declarant a les sis declaracions (nom, NIF, domicili, correu, telèfon i data) i signar-les.
...
5. Executar el preflight amb voluntariat adult extern **abans d'activar cap persona treballadora municipal** i lliurar-ne els resultats a l'Ajuntament.
...
- dades personals i signatura del declarant a les sis declaracions;
