...
/**
 * Proyección de tendencia (NO es un modelo predictivo): extrapolación lineal
 * del trend histórico + cono de incertidumbre basado en la varianza observada.
 * `crossWeek` = índice global 0-based de la 1ª semana proyectada que alcanza
 * el umbral de burnout (50), o null si no lo cruza.
 */
...
/** Elemento de benchmark: valor de la organización vs referencia ilustrativa. */
...
export interface DashboardData {
  ...
  heatmap: Heatmap;
  heatmaps: Heatmap[];
  /** Benchmark sectorial ilustrativo (referencia, no de un dataset real). */
